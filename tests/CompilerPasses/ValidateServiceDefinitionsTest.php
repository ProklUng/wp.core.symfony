...
namespace Prokl\ServiceProvider\Tests\CompilerPasses;
 ...
 * @package Prokl\ServiceProvider\Tests\CompilerPasses
...
class ValidateServiceDefinitionsTest extends BaseTestCase
{
    ...
    public function testProcessInvalidClass(): void
    {
        ...
        $this->expectExceptionMessage(
            'Service test_service is configured to use the nonexistent class Prokl\ServiceProvider\Tests\CompilerPasses\FakeClass'
        );
